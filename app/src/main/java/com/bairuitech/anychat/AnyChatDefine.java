...
public class AnyChatDefine {
    ...
    public static final int ANYCHAT_CORESDKEVENT_AIABILITY = 102;
    public static final int ANYCHAT_CORESDKEVENT_APPBUFFER = 103;
    ...
    public static final int ANYCHAT_CORESDKEVENT_FACEEMOTION = 40;
    public static final int ANYCHAT_CORESDKEVENT_LIVESTREAM = 101;
    ...
    public static final int ANYCHAT_CORESDKEVENT_RECORDSTATUS = 13;
    public static final int ANYCHAT_CORESDKEVENT_REGEDITDATA = 41;
    public static final int ANYCHAT_CORESDKEVENT_REQUESTEX = 42;
    ...
    public static final int ANYCHAT_RECORD_FLAGS_FILEMD5 = 262144;
    ...
    public static final int ANYCHAT_SDKCTRL_AIABILITY = 102;
    public static final int ANYCHAT_SDKCTRL_APPBUFFER = 103;
    ...
    public static final int ANYCHAT_SDKCTRL_FACEEMOTIONCTRL = 300;
    ...
    public static final int ANYCHAT_SDKCTRL_LIVESTREAM = 101;
    ...
    public static final int ANYCHAT_SERVERQUERY_USERINFOBYID = 6;
    ...
    public static final int BRAC_SO_CORESDK_DISABLELOGFILE = 139;
    ...
    public static final int BRAC_SO_CORESDK_LASTERRORCODE = 237;
    ...
    public static final int BRAC_SO_CORESDK_SETUSERAPPINFO = 236;
